...
enum AchievementCatalog {
    ...
    static let all: [Achievement] = [
        Achievement(
            ...
            titleEN: "First Circuit", titleES: "Primer Circuito", titleFR: "Premier Circuit", titleJA: "最初の回路",
            ...
            subtitleJA: "最初のレベルをクリアしてシグナルを灯せ。",
        ...
        Achievement(
            ...
            titleEN: "Signal Apprentice", titleES: "Aprendiz de Se\u{00F1}al", titleFR: "Apprenti du Signal", titleJA: "シグナル見習い",
        ...
        Achievement(
            ...
            titleEN: "Route Engineer", titleES: "Ingeniero de Ruta", titleFR: "Ing\u{00E9}nieur de Route", titleJA: "ルートエンジニア",
        ...
        Achievement(
            ...
            titleEN: "Void Architect", titleES: "Arquitecto del Vac\u{00ED}o", titleFR: "Architecte du Vide", titleJA: "ヴォイドアーキテクト",
            subtitleEN: "Complete all 330 levels.",
            subtitleES: "Completa los 330 niveles.",
            subtitleFR: "Termine les 330 niveaux.",
            subtitleJA: "全330レベルをクリアせよ。",
        ...
        Achievement(
            ...
            titleEN: "Easy Mastered", titleES: "F\u{00E1}cil Dominado", titleFR: "Facile Ma\u{00EE}tris\u{00E9}", titleJA: "イージー制覇",
        ...
        Achievement(
            ...
            titleEN: "Medium Mastered", titleES: "Medio Dominado", titleFR: "Moyen Ma\u{00EE}tris\u{00E9}", titleJA: "ミディアム制覇",
            subtitleEN: "Clear all Medium levels.",
            subtitleES: "Supera todos los niveles Medio.",
            subtitleFR: "Termine tous les niveaux Moyen.",
            subtitleJA: "すべてのミディアムレベルをクリアせよ。",
        ...
        Achievement(
            ...
            titleEN: "Hard Mastered", titleES: "Dif\u{00ED}cil Dominado", titleFR: "Difficile Ma\u{00EE}tris\u{00E9}", titleJA: "ハード制覇",
        ...
        Achievement(
            ...
            titleEN: "Expert Mastered", titleES: "Experto Dominado", titleFR: "Expert Ma\u{00EE}tris\u{00E9}", titleJA: "エキスパート制覇",
            subtitleEN: "Clear all Expert levels.",
            subtitleES: "Supera todos los niveles Experto.",
            subtitleFR: "Termine tous les niveaux Expert.",
            subtitleJA: "すべてのエキスパートレベルをクリアせよ。",
        ...
        Achievement(
            ...
            titleEN: "Optimal Route", titleES: "Ruta \u{00D3}ptima", titleFR: "Route Optimale", titleJA: "最適ルート",
        ...
        Achievement(
            ...
            titleEN: "Perfectionist", titleES: "Perfeccionista", titleFR: "Perfectionniste", titleJA: "完璧主義者",
            ...
            subtitleJA: "任意のレベルで50回パーフェクトスコアを獲得せよ。",
        ...
        Achievement(
            ...
            titleEN: "Branching Mastered", titleES: "Ramificaci\u{00F3}n Dominada", titleFR: "Ramification Ma\u{00EE}tris\u{00E9}e", titleJA: "分岐マスター",
        ...
        Achievement(
            ...
            titleEN: "Density Controlled", titleES: "Densidad Controlada", titleFR: "Densit\u{00E9} Contr\u{00F4}l\u{00E9}e", titleJA: "密度制御",
            subtitleEN: "Clear all Dense levels.",
            subtitleES: "Supera todos los niveles Densos.",
            subtitleFR: "Termine tous les niveaux Denses.",
            subtitleJA: "すべての高密度レベルをクリアせよ。",
        ...
        Achievement(
            ...
            titleEN: "Multi-Node", titleES: "Multinodo", titleFR: "Multi-Noeud", titleJA: "マルチノード",
            ...
            subtitleJA: "すべてのマルチノードレベルをクリアせよ。",
        ...
        Achievement(
            ...
            titleEN: "No Blink", titleES: "Sin Parpadeo", titleFR: "Sans Clignotement", titleJA: "瞬きなし",
